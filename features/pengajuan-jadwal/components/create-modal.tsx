...
export function JadwalModal() {
    ...
    const open = isOpen("jadwalRequestModal");
    const jadwal = getData("jadwalRequestModal");
    ...
    return (
        <>
            <BaseModal open={open} onOpenChange={(v) => !v && close("jadwalRequestModal")} size="lg">
                <BaseModal.Header>
                ...
                <BaseModal.Footer>
                    <BaseModal.CloseButton onClick={() => close("jadwalRequestModal")} />
                    <Button
                        type='submit'
